...
public final class Selenium2Utils {
	private static Logger logger = LogManager.getLogger(Selenium2Utils.class);
	...
	public static final class Wait {
		...
		public static void waitForElementFoundByClassName(final WebDriver driver, final String className,
				final long timeout) {
			Preconditions.checkNotNull(className);
		...
		public static void tryWaitForElementFoundByClassName(final WebDriver driver, final String className,
				final long timeout) {
			try {
		...
		public static void waitForElementFoundByLinkText(final WebDriver driver, final String linkText,
				final long timeout) {
			Preconditions.checkNotNull(linkText);
			new WebDriverWait(driver, timeout).until(new ExpectedCondition<Boolean>() {
		...
		public static void tryWaitForElementNotFoundByLinkText(final WebDriver driver, final String id,
				final long timeout) {
			try {
		...
		public static void waitForElementNotFoundByLinkText(final WebDriver driver, final String linkText,
				final long timeout) {
			Preconditions.checkNotNull(linkText);
		...
		public static void tryWaitForElementFoundByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			try {
		...
		public static void waitForElementHasValueByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			Preconditions.checkNotNull(xpath);
		...
		public static void waitForElementContainsById(final WebDriver driver, final String id, final String value,
				final long timeout) {
			Preconditions.checkNotNull(id);
			...
			new WebDriverWait(driver, timeout).until(new ExpectedCondition<Boolean>() {
				...
				public final Boolean apply(final WebDriver theDriver) {
					...
					final String textValueOfElement = element.getText();
					final boolean hasText = textValueOfElement != null && !textValueOfElement.isEmpty()
							&& textValueOfElement.contains(value);
					return hasText;
				}
			});
		}

		public static void waitForElementContainsByXPath(final WebDriver driver, final String xpath, final String value,
				final long timeout) {
			Preconditions.checkNotNull(xpath);
			Preconditions.checkNotNull(value);
		...
		public static void tryWaitForElementContainsByXPath(final WebDriver driver, final String xpath,
		...
		public static void waitForElementEnabledByClassName(final WebDriver driver, final String className,
				final long timeout) {
			Preconditions.checkNotNull(className);
			new WebDriverWait(driver, timeout).until(new ExpectedCondition<Boolean>() {
		...
		public static void waitForElementEnabledByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			Preconditions.checkNotNull(xpath);
		...
		public static void waitForElementDisplayedByClassName(final WebDriver driver, final String className,
				final long timeout) {
			Preconditions.checkNotNull(className);
			new WebDriverWait(driver, timeout).until(new ExpectedCondition<Boolean>() {
		...
		public static void waitForElementDisplayedByLinkText(final WebDriver driver, final String linkText,
				final int timeout) {
			Preconditions.checkNotNull(linkText);
			new WebDriverWait(driver, timeout).until(new ExpectedCondition<Boolean>() {
		...
		public static void waitForElementDisplayedByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			Preconditions.checkNotNull(xpath);
		...
		public static void waitForElementNotDisplayedByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			Preconditions.checkNotNull(xpath);
		...
		public static void waitForElementNotDisplayedByClassName(final WebDriver driver, final String className,
				final long timeout) {
			Preconditions.checkNotNull(className);
		...
		public static void tryWaitForElementDisplayedByXPath(final WebDriver driver, final String xpath,
				final long timeout) {
			try {
		...
		public static void tryWaitForElementFoundByLinkText(final WebDriver driver, final String link,
				final int timeout) {
			try {
